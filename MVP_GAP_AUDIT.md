...
> **Update 2026-06-12:** DEC-12 briefly switched the payments provider to MYOB;
> DEC-13 (same day) switched it back to **Xero** after MYOB's developer program
> turned out to be paid-tier only. The finding, and the A4 rescope below, stand
> as written; the build contract is XERO_INTEGRATION_CONTRACT.md.
