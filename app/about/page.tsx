...
export const metadata: Metadata = {
  ...
  description:
    "Why Isobel Hardwick is building TheBigIntro: fix irrelevant outreach for senior leaders and make every meeting count for a cause that matters.",
};
  ...
  return (
    <>
      <header className="wrap hero">
        ...
        <p className="lede">
          Senior people are buried in irrelevant outreach. Vendors with genuine
          value cannot get through honestly. TheBigIntro is an attempt to fix
          both at once, and to make every meeting count.
        </p>
        <div className="cta">
          ...
          <div className="founder">
            ...
            <div>
              ...
              <p style={{ marginTop: 14 }}>
                ...
                rule: earn the meeting by being relevant, and make the meeting
                worth something beyond the deal.
              </p>
              <p style={{ marginTop: 14 }}>
        ...
        <div className="wrap">
          <div className="founding">
            ...
            <p>
              ...
              in how TheBigIntro runs. Places are limited.
            </p>
            <CallButton>Start a conversation</CallButton>
          </div>
        </div>
