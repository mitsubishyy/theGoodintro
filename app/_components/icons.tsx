// Refined line-illustration set, locked with the fresh design direction.
// Thin consistent stroke, no fills, one small coral or mint accent.
...
export function FloatCalendar() {
  return (
    <svg className="floaty f1" width="96" height="96" viewBox="0 0 64 64" fill="none" aria-hidden="true">
      <rect x="12" y="14" width="40" height="38" rx="8" className="ln" strokeWidth="2.4" />
      <path d="M12 25h40M23 11v7M41 11v7" className="ln" strokeWidth="2.4" />
      <path d="M24 38l6 6 11-13" className="ln-c" strokeWidth="3" />
    </svg>
  );
}

export function FloatHeartCoin() {
  return (
    <svg className="floaty f2" width="84" height="84" viewBox="0 0 64 64" fill="none" aria-hidden="true">
      <path
        d="M32 51C20 43 13 35 13 26a9 9 0 0 1 19-5 9 9 0 0 1 19 5c0 9-7 17-19 25z"
        className="ln"
        strokeWidth="2.6"
      />
...
export function ChipCheck() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true">
      <circle cx="12" cy="12" r="8.5" className="ln-c" strokeWidth="2.2" />
      <path d="M8.5 12.5l2.5 2.5 4.5-5.5" className="ln-c" strokeWidth="2.2" />
    </svg>
  );
}
...
export function ChipInfo() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true">
      <circle cx="12" cy="12" r="8.5" className="ln-m" strokeWidth="2.2" />
      <path d="M12 8v5M12 16h.01" className="ln-m" strokeWidth="2.2" />
    </svg>
  );
}

export function ChipHeart() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true">
      <path
...
export function IcoHeartDollar() {
  return (
...
export function IcoBadgeCheck() {
  return (
    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
      <path
        d="M24 6l4.6 3.4 5.7-.2 1.7 5.4 4.6 3.4-1.7 5.4 1.7 5.4-4.6 3.4-1.7 5.4-5.7-.2L24 42l-4.6-3.4-5.7.2-1.7-5.4-4.6-3.4 1.7-5.4-1.7-5.4 4.6-3.4 1.7-5.4 5.7.2z"
        className="ln"
        strokeWidth="2.2"
      />
      <path d="M18 24l4.5 4.5 8.5-9" className="ln-c" strokeWidth="2.6" />
    </svg>
  );
}

export function IcoHeartPlus() {
  return (
    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
      <path
...
export function IcoPerson() {
  return (
    <svg className="ic" width="52" height="52" viewBox="0 0 64 64" fill="none" aria-hidden="true">
      <circle cx="32" cy="22" r="10" className="ln-c" strokeWidth="2.6" />
      <path d="M14 52c0-10 8-16 18-16s18 6 18 16" className="ln-c" strokeWidth="2.6" />
    </svg>
  );
}
...
export function IcoChat() {
  return (
    <svg className="ic" width="52" height="52" viewBox="0 0 64 64" fill="none" aria-hidden="true">
      <path
        d="M14 16h30a6 6 0 0 1 6 6v14a6 6 0 0 1-6 6H26l-12 9V22a6 6 0 0 1 6-6z"
        className="ln-m"
        strokeWidth="2.6"
      />
