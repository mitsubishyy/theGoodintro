    ...
    <main className="mx-auto max-w-2xl px-6 py-16" style={{ color: "var(--foreground)" }}>
      ...
      <div className="mt-8 rounded-2xl border p-6" style={{ background: "var(--portal-card)", borderColor: "var(--portal-line)" }}>
        ...
        {vendor?.status === "active" ? (
          <Link href="/vendor/executives" className="mt-4 inline-block rounded-lg px-4 py-2 text-sm font-semibold" style={{ background: "var(--portal-ink)", color: "var(--portal-card)" }}>
            Browse executives
          </Link>
        ) : null}
      </div>
