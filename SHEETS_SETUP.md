...
var LABELS = [
  ...
  ["beyondCharity","Beyond the charity, what else makes it worth their time"],
  ["beyondCharityOther","Beyond the charity (other)"],
  ["vendorMustProvide","What a vendor must provide to judge relevance"],
  ["vendorMustProvideOther","Vendor must provide (other)"],
  ["needToSee","What they'd need to see on the platform before joining"],
  ["needToSeeOther","Need to see (other)"],
  ["questionnaireWilling","Would spend 5 min on a priorities questionnaire"],
  ["shareWithVendor","OK to share those priorities with the vendor"],
  ["guidance","Guidance for me building this"],
  ["wouldRefer","Would point a peer toward this"],
...
'<p style="margin:14px 0 0;font-size:15px;line-height:1.6;color:#6F675B;">Thanks for taking the time to help a stranger shape something good. If you ticked Yes on the last question, I\'ll be in touch soon. Looking forward to saying hi properly.</p>',
'</td></tr>',
