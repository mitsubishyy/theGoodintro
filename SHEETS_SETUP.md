...
'<p style="margin:14px 0 0;font-size:15px;line-height:1.6;color:#6F675B;">Thanks for taking the time to help a stranger shape something <span style="color:#1F7A52;font-weight:600;">good</span>. If you ticked Yes on the last question, I\'ll be in touch soon. Looking forward to it.</p>',
'</td></tr>',
